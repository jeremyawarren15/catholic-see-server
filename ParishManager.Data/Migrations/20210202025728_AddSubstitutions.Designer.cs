...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParishManager.Core.Entities.SubstitutionRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ParishManager.Core.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ParishManager.Core.Entities.SubstitutionRequest", b =>
                {
                    b.HasOne("ParishManager.Core.Entities.User", "Substitute")
                        .WithMany()
                        .HasForeignKey("SubstitutionUserId");

                    b.HasOne("ParishManager.Core.Entities.TimeSlotCommitment", "TimeSlotCommitment")
                        .WithMany()
                        .HasForeignKey("TimeSlotCommitmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ParishManager.Core.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ParishManager.Core.Entities.TimeSlot", b =>
                {
                    b.HasOne("ParishManager.Core.Entities.Parish", "Parish")
                        .WithMany("TimeSlots")
            ...
            modelBuilder.Entity("ParishManager.Core.Entities.TimeSlotCommitment", b =>
                {
                    b.HasOne("ParishManager.Core.Entities.TimeSlot", "TimeSlot")
